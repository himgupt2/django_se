...
class PreData(models.Model):
    testkey = models.ForeignKey(PhageData, related_name='PhageName',on_delete=models.DO_NOTHING)
    phagename = models.CharField(max_length=30, default='none')

class ExperimentData(models.Model):
    expkey = models.ForeignKey(PhageData, related_name='PName',on_delete=models.DO_NOTHING)
...
class IsolationData(models.Model):
    isokey = models.ForeignKey(PhageData, related_name='iso_phageName',on_delete=models.DO_NOTHING)
